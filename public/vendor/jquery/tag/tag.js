(function() {
  ...
  testApp = angular.module('ngTagsInput', []);
...
window.CP.exitedLoop(1);
      ...
      template: "<div class='form-control auto_height'>"+
          "<div class='input-tag bg-info' data-ng-repeat=\"tag in tagArray() track by $index\" >"+
              "{{tag}}"+
              "<div class='delete-tag' data-ng-click='deleteTag($index)'>"+
                "&times;"+
              "</div>"+
            "</div>"+
            "<input type='text' style='padding:0;border:none' class='form-control tags' data-ng-model='tagText' placeholder='{{placeholder}}'/>"+
          "</div>"
    };
  });
