    ...
    <div class="w3-col m12">
      <div class="w3-card-2 w3-round w3-white w3-margin">
        <div class="w3-container w3-padding-small">
          ...
          <a href="{{url('blog/category').'/'.@$single->slug_cat}}" title="{{@$single->judul_cat}}" >{{@$single->judul_cat}}</a> /
          {{@$single->judul}}
          </small>
        </div>
      </div>
  ...
  <div class="w3-col l1 w3-hide-medium w3-hide-small">
    ...
    <div class="w3-container w3-white ">
      <div style="position: fixed;">
        ...
        <a href="mailto:?Subject={{@$single->judul}}&amp;Body={{@$single->judul}} {{url('blog').'/'.@$single->slug}}" target="_blank" style="background-color: #F14336" class="w3-bar-item w3-button"><img src="{{asset('front')}}/email.png" alt="email" width="25px"></a><br>
        <a href="whatsapp://send?text={{@$single->judul}} {{url('blog').'/'.@$single->slug}}" target="_blank" style="background-color: #65BC54" class="w3-bar-item w3-button"><img src="{{asset('front')}}/wa.png" alt="whatsapp" width="25px"></a><br>
        <a href="https://lineit.line.me/share/ui?url={{url('blog').'/'.@$single->slug}}" target="_blank" style="background-color: #3FD037" class="w3-bar-item w3-button"><img src="{{asset('front')}}/line.png" alt="line" width="25px"></a><br>
        <a href="http://www.facebook.com/sharer.php?u={{url('blog').'/'.@$single->slug}}" target="_blank" style="background-color: #3B5998" class="w3-bar-item w3-button"><img src="{{asset('front')}}/facebook.png" alt="facebook" width="25px"></a><br>
        <a href="https://twitter.com/share?url={{url('blog').'/'.@$single->slug}}&amp;text={{@$single->judul}}&amp;hashtags={{@$single->judul}}" target="_blank" style="background-color: #55ACEE" class="w3-bar-item w3-button"><img src="{{asset('front')}}/twitter.png" alt="twitter" width="25px"></a><br>
      </div>
    </div>
  </div>
  <div class="w3-bottom w3-hide-large">
    <div class="w3-bar w3-black w3-center ">    
      <a href="mailto:?Subject={{@$single->judul}}&amp;Body={{@$single->judul}} {{url('blog').'/'.@$single->slug}}" target="_blank" style="width:20%;background-color: #F14336" class="w3-bar-item w3-button"><img src="{{asset('front')}}/email.png" alt="email" width="25px"></a>
      <a href="whatsapp://send?text={{@$single->judul}} {{url('blog').'/'.@$single->slug}}" target="_blank" style="width:20%;background-color: #65BC54" class="w3-bar-item w3-button"><img src="{{asset('front')}}/wa.png" alt="whatsapp" width="25px"></a>
      <a href="https://lineit.line.me/share/ui?url={{url('blog').'/'.@$single->slug}}" target="_blank" style="width:20%;background-color: #3FD037" class="w3-bar-item w3-button"><img src="{{asset('front')}}/line.png" alt="line" width="25px"></a>
      <a href="http://www.facebook.com/sharer.php?u={{url('blog').'/'.@$single->slug}}" target="_blank" style="width:20%;background-color: #3B5998" class="w3-bar-item w3-button"><img src="{{asset('front')}}/facebook.png" alt="facebook" width="25px"></a>
      <a href="https://twitter.com/share?url={{url('blog').'/'.@$single->slug}}&amp;text={{@$single->judul}}&amp;hashtags={{@$single->judul}}" target="_blank" style="width:20%;background-color: #55ACEE" class="w3-bar-item w3-button"><img src="{{asset('front')}}/twitter.png" alt="twitter" width="25px"></a>          
    </div>
  </div>
